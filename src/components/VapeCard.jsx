...
const VapeCard = ({ product, i }) => {
  return (
    <div className=" font-sans rounded-lg max-[500px]:h-auto h-[268.6px]  flex relative justify-center items-center max-[500px]:w-[80%] w-[180px] ">
      <div className=" cursor-pointer flex flex-col justify-center items-center  ">
        ...
        <p className="font-sans font-semibold tetx-[1rem] ">
          {product.promotePrice} MMK
        </p>
        <p className="font-sans line-through text-[12px] ">
        ...
        <div className=" flex justify-center items-center ">
          ...
          <p className=" tracking-wider font-sans font-medium text-yellow-400 text-[13px] ">
            {" "}
