...
const DevicesNew = () => {
  ...
  return /*#__PURE__*/ _jsx("div", {
    className:
      " w-[96%] rounded-lg justify-center items-center bg-black max-[500px]:mx-5  ",
    style: {
      background:
        ...
        : devices.map(
            (cate, i) =>
              ...
              /*#__PURE__*/ _jsxs(
                ...
                {
                  className:
                    "rounded-lg relative max-[500px]:flex-col flex w-full justify-between items-center ",
                  children: [
                    /*#__PURE__*/ _jsx("div", {
                      className:
                        " min-w-[20%] max-[500px]:w-full flex max-[500px]:p-2 p-4 justify-center items-center ",
                          ...
                          /*#__PURE__*/ _jsxs("div", {
                            ...
                            children: [
                              ...
                              /*#__PURE__*/ _jsx(Typography, {
                                ...
                                children: "Try the best for you here!"
                              })
                            ]
                          })
                        ]
                    ...
                    /*#__PURE__*/ _jsx("div", {
                      className:
                        " transition-all flex max-[500px]:rounded-lg rounded-r-lg max-[500px]:w-[100%] w-[80%] gap-2 max-[500px]:p-2   p-2 overflow-hidden    ",
                      children: /*#__PURE__*/ _jsx("div", {
                        ...
                        children: cate.productListBuyers
                          .slice(0, 6)
                          .map((product, i) =>
                            /*#__PURE__*/ _jsxs(
                              "div",
                                ...
                                children: [
                                  ...
                                  /*#__PURE__*/ _jsxs("div", {
                                    ...
                                    children: [
                                      ...
                                      /*#__PURE__*/ _jsxs("p", {
                                        className:
                                          " tracking-wider font-sans font-medium text-yellow-400 max-[500px]:text-[12px] text-[12px] ",
                                        children: [" ", "600 Points", " "]
                                      })
                                    ]
                                  })
