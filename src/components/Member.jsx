        ...
        <Grid item lg={7} xs={12}>
            ...
            >
                ...
                >
                    ...
                    <button className=" bg-[#212121c7] text-white font-sans px-[1rem] py-[.2rem] hover:bg-[#4a4a4a55] rounded-3xl " id='slideButton'>View</button>
                </Stack>
                {
                    desktop && <img src="/images/premium.png" alt="premium" className="premiumImg"/>
                }
